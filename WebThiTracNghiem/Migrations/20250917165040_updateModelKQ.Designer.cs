...
namespace WebThiTracNghiem.Migrations
{
    ...
    [Migration("20250917165040_updateModelKQ")]
    partial class updateModelKQ
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebThiTracNghiem.Areas.Admin.Models.AdminNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebThiTracNghiem.Models.ChiTietDeThi", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebThiTracNghiem.Models.ChiTietKQ", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebThiTracNghiem.Models.ChiTietKQ_DapAn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ChiTietKQId");

                    b.HasIndex("DapAnId");

                    b.ToTable("ChiTietKQ_DapAn");
                });

            modelBuilder.Entity("WebThiTracNghiem.Models.ChuDe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebThiTracNghiem.Models.KetQua", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("GioLam")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("GioNop")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebThiTracNghiem.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebThiTracNghiem.Models.ChiTietDeThi", b =>
                {
                    b.HasOne("WebThiTracNghiem.Models.CauHoi", "CauHoi")
                        .WithMany()
            ...
            modelBuilder.Entity("WebThiTracNghiem.Models.ChiTietKQ", b =>
                {
                    ...
                    b.HasOne("WebThiTracNghiem.Models.KetQua", "KetQua")
                        .WithMany("ChiTietKQs")
            ...
            modelBuilder.Entity("WebThiTracNghiem.Models.ChiTietKQ_DapAn", b =>
                {
                    b.HasOne("WebThiTracNghiem.Models.ChiTietKQ", "ChiTietKQ")
                        .WithMany("DapAnChons")
                        .HasForeignKey("ChiTietKQId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebThiTracNghiem.Models.DapAn", "DapAn")
                        .WithMany()
                        .HasForeignKey("DapAnId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("ChiTietKQ");
            ...
            modelBuilder.Entity("WebThiTracNghiem.Models.DeThi", b =>
                {
                    b.HasOne("WebThiTracNghiem.Models.ApplicationUser", "GiangVien")
                        .WithMany()
            ...
            modelBuilder.Entity("WebThiTracNghiem.Models.KetQua", b =>
                {
                    ...
                    b.HasOne("WebThiTracNghiem.Models.ApplicationUser", "SinhVien")
                        .WithMany("KetQuaList")
            ...
            modelBuilder.Entity("WebThiTracNghiem.Models.CauHoi", b =>
                {
                    b.Navigation("DapAnList");
                });

            modelBuilder.Entity("WebThiTracNghiem.Models.ChiTietKQ", b =>
                {
                    b.Navigation("DapAnChons");
                });
